    ...
    <section className="relative py-16 px-4">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {/* Contact Form Card */}
          <div className="bg-[rgb(43,28,72)]/70 rounded-3xl p-5 shadow-2xl flex flex-col h-full order-2 lg:order-1 transition-all duration-300 hover:shadow-3xl hover:scale-[1.02] hover:bg-[rgb(43,28,72)]/80">
            <div className="mb-4">
          ...
          <div className="bg-[rgb(43,28,72)]/70 rounded-3xl p-5 shadow-2xl flex flex-col h-full order-1 lg:order-2 transition-all duration-300 hover:shadow-3xl hover:scale-[1.02] hover:bg-[rgb(43,28,72)]/80">
            <div className="mb-4">
              <h2 className="text-white text-lg font-medium mb-1">Our Location</h2>
              <h3 className="text-white text-2xl font-bold">Visit Our Office</h3>
              <div className="w-12 h-1 bg-orange-500 mt-2"></div>
            </div>
